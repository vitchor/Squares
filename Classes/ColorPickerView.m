...
-(void) setActualColorWithHue:(float)hue Sat:(float)sat Bri:(float)bri{
	...
	[gradientView setTheColor:currentColor.CGColor];
	[gradientView setupGradient];
	[gradientView setNeedsDisplay];
	...
	[self getStringForRGB:currentColor.CGColor];
	[self getStringForHSL:currentHue :currentSaturation :currentBrightness];
	//[forColorView release];
	
	UIColor *nemColor = [UIColor colorWithHue:currentHue 
			   saturation:currentSaturation 
			   brightness:currentBrightness
										alpha:1.0];
	
	[(PlayerInfoViewController *)parentView setNewColorWithHue:currentHue Sat:currentSaturation Bri:currentBrightness Color:nemColor];
	[nemColor release];
}
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
	...
	[(PlayerInfoViewController *)parentView setNewColorWithHue:currentHue Sat:currentSaturation Bri:currentBrightness Color:[UIColor colorWithHue:currentHue 
																																	   saturation:currentSaturation 
																																	   brightness:currentBrightness
																																			alpha:1.0]];
